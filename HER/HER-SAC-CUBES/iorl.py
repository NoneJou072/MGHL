...
class IORL:
    ...
    def update(self):
        ...
        batch_s = torch.concatenate((batch_s_2, batch_s_3, batch_s_4))
        batch_a = torch.concatenate((batch_a_2, batch_a_3, batch_a_4))
        batch_s_ = torch.concatenate((batch_s_2_, batch_s_3_, batch_s_4_))
        batch_r = torch.concatenate((batch_r_2, batch_r_3, batch_r_4))
        batch_g = torch.concatenate((batch_g_2, batch_g_3, batch_g_4))
